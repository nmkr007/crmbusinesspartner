...
if (isset ( $_GET ['q'] )) {
	...
	$sql = "SELECT companyid, companyname, password FROM companies
	...
	if (mysqli_num_rows ( $result ) > 0) {
		...
		<thead><tr align=\"left\" valign=\"top\" style=\"color:Red;font-style:italic\"><th>Company Name</th>
<th>Password</th><th>Delete</th></tr></thead><tbody>";
		// output data of each row
		while ( $row = mysqli_fetch_assoc ( $result ) ) {
			
			
			echo "<tr align=\"left\" valign=\"top\" style=\"color:blue\"><td>" . 
			$row ["companyname"] . "</td><td>". $row ['password'] . "</td>
